...
[![CV](https://img.shields.io/badge/CV-EN-blue?style=flat-square&logo=adobeacrobatreader)](https://github.com/GuilhermeBorSan/My-Docs/blob/main/EN-US.md)
...
+200 educadores impactados por metodologias de aprendizagem documentadas e mais de 3 anos produzindo **materiais digitais e bases de conhecimento**.  
...
## 💡 Como agrego valor  
- Domínio de: **Git, Confluence, Markdown, Jira, Notion, Trello**  
- Certificações: **API Technical Writing, Agile Scrum, Software Documentation**  
- Fluente em **inglês (C2)** com experiência internacional e multicultural  
...
|--------------|---------------|------------|-------------|
| 📝 **Redação Técnica** | 📚 API Technical Writing (REST, JSON, XML) | Produção de registros padronizados como **Examinador Oral na University of Cambridge**, garantindo clareza e consistência. | 💬 Comunicação clara e precisa |
| 🗂 **Gestão do Conhecimento** | 📚 Tech Writers Master Class | Estruturei processos de documentação como **Mentor de Inovação na Casa Thomas Jefferson**, apoiando treinamentos e projetos internos. | 🧠 Organização e gestão de informações |
| 🎨 **Design da Informação** | 📚 JPDocu School | Criei materiais digitais e instrucionais como **Coordenador Bilíngue no Colégio La Salle**, integrando métodos de ensino inovadores. | 🔍 Atenção aos detalhes e síntese |
| ⚡ **Metodologias Ágeis** | 📚 Agile Scrum Fundamentals | Coordenei iniciativas colaborativas em equipes multiculturais como **Mentor de Inovação na Casa Thomas Jefferson**. | 🤝 Trabalho em equipe e adaptabilidade |
| 🛠 **Git, Markdown, Confluence, Jira** | 📚 Curso de JIRA e Confluence | Mantive documentação estruturada e versionada como **Professor de Inglês na Casa Thomas Jefferson**. | 🎯 Rigor técnico e precisão |
| 🌍 **Idiomas**: Inglês (C2), Espanhol (A2), Francês (A2) | 📚 Google for Education Nível 2 | Tradução e revisão de conteúdo multilíngue como **Professor de Inglês na Casa Thomas Jefferson**. | 🌐 Comunicação intercultural e empatia |
